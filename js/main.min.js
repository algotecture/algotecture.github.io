...
"use strict";!function(o){var e=document.getElementById("css-preloader");o.onload=function(){return setTimeout(function(){return function(o){o.style.opacity=1;var e=setInterval(function(){o.style.opacity=o.style.opacity-.05,o.style.opacity<=.05&&(clearInterval(e),o.style.display="none")},16)}(e)},1e3)}}(window),$(function(){$("#greeting-video").click(function(){$(".algo-video-popover").addClass("algo-video-popover-show")}),$(".algo-video-popover-close-button").click(function(){$(".algo-video-popover").removeClass("algo-video-popover-show")})});